...
项目节点配置文件于MainWindow.xaml.cs中，其中的Win_load方法用于可以配置节点树。

#### 2.节点内容切换方法

于LabelConfig.cs可以使用根据Win_load中的节点路径来配置CTRL + T切换文本内容

#### 3.项目快捷键配置文件

InteractionConfig.cs 可以配置快捷键内容

#### 4.默认快捷键配置

|       快捷键       |       功能       |
| :----------------: | :--------------: |
| CTRL + SHIFT + F12 | 唤醒项目输入页面 |
|      CTRL + T      | 改变节点标签内容 |
